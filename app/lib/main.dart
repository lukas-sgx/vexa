...
class _Dashboard extends State<DashPage> {
  ...
  Future<double> _getSold() async {
    var response = await http.post(
      Uri.parse("http://192.168.137.173:5500/api/connected.php"),
      body: {
        "number": "1",
        "cmd": "getSold",
      },
    ...
    if(_selectedIndex == 0){
      return Column(
        children: [
          ...
          Column(
            children: [
              _buildTile("Netflix", "Today, 7:10am", "card"),
              _buildTile("Free", "Yearsteday, 9:21pm", "levy"),
              _buildTile("Sevan", "Yearsteday, 1:38pm", "transfert"),
            ],
          ),
